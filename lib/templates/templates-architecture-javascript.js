 ...
 */
const TEMPLATE_COMPONENT_REACT = (name) => {
  return (
    `import React from 'react';
    \nconst ${pascalCase(name)} = () => {\n\treturn <div className="component-${kebabCase(name)}__container"><h1>${kebabCase(name)}</h1></div>\n}
...
const TEMPLATE_COMPONENT_REACT_INDEX = (name) => {
  return (
    ...
    \nconst App = () => {\n\treturn <div className="app-${kebabCase(name)}__container"><h1>${kebabCase(name)}</h1></div>\n}
